  ...
  function pifagor(pifag) {
    ...
    return '<div class="pifagor-square" id="result"><table rules="all" cellspacing="10" cellpadding="10" style="margin-top:20px; "><tbody>'+
        ...
        '<tr align="center">'+
          ...
          '<td colspan="2" height="110px"> <p class="stp extr_num_mg" style="font-size:12px;" >Додаткові Числа</p><div id="dynamicText"> <p  class="stp extr_num_mg" style="font-size:12px;">'+rch1+', '+rch2+', '+rch3+', '+rch4+' </p> <p class="lined extr_num_mg" style="font-size:12px;">'+fkol_1+'/ '+fkol_2+'/ '+fkol_3+'/ '+fkol_4+'/ '+fkol_5+'/ '+fkol_6+'/ '+fkol_7+'/ '+fkol_8+'/ '+fkol_9+'/ ЧД '+rch2+' </p>  </div></td> ' +
          '</tbody> ' +
          '</table>'
